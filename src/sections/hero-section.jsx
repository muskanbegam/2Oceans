...
export default function HeroSection() {
    return (
        <section className="flex flex-col items-center -mt-36">
            <motion.svg className="absolute -z-10 w-full -mt-30 md:mt-0" width="1440" height="676" viewBox="0 0 1440 676" fill="none" xmlns="http://www.w3.org/2000/svg"
                initial={{ opacity: 0 }}
            ...
            >
                Future-Ready Technology & Training
            </motion.h1>
            <motion.p className="text-center text-base max-w-lg mt-2"
                ...
                transition={{ delay: 0.2, type: "spring", stiffness: 320, damping: 70, mass: 1 }}
            >
        Helping organizations grow through practical training, smart IT consulting, and future-ready solutions.            </motion.p>
...
<a
    href="#contact"
    className="flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-700 transition text-white active:scale-95 rounded-lg px-7 h-11"
>
    Get started
